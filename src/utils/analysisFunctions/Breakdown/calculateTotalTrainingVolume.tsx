...
function calculateTotalTrainingVolume(
    ...
    request.onerror = (event) => {
      toast.error("Oops, calculateTotalTrainingVolume has an error!")      
    ...
    request.onsuccess = (event) => {
      ...
      getDataRequest.onsuccess = () => {
        ...
        const totalVolume = calculateTotalVolume(data, timeframe, selectedStartDate, selectedEndDate);
  
        console.log("Total Training Volume:", totalVolume);
  
        setInitialRawData(totalVolume);
      };
  
      getDataRequest.onerror = () => {
        toast.error("Oops, getDataRequest in calculateTotalTrainingVolume has an error!")           
        console.error(getDataRequest.error);
      };
    };
  }
  
  function calculateTotalVolume(data: any[], timeframe: string, selectedStartDate: any, selectedEndDate: any) {
    let totalVolume = 0;
  ...
  export default calculateTotalTrainingVolume;
