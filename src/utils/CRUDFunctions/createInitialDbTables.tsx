...
function createInitialDbTables(): Promise<void> {
    return new Promise<void>((resolve, reject) => {
      ...
      request.onupgradeneeded = function () {
        ...
        store.createIndex("exercise_favorite", "favorite", { unique: false });
        ...
        body_tracker.createIndex("bodytracker_value", "value", {
          unique: false,
        });
        ...
        workout_evaluation.createIndex("workout_evaluation_rating", "rating", {
          unique: false,
        });
        workout_evaluation.createIndex("workout_evaluation_date", "date", {
          unique: true,
        });
        workout_evaluation.createIndex(
          "workout_evaluation_comment",
          "comment",
          { unique: false }
        );
        workout_evaluation.createIndex("workout_evaluation_train", "train", {
          unique: false,
        });
        workout_evaluation.createIndex("workout_evaluation_pain", "pain", {
          unique: false,
        });
        workout_evaluation.createIndex(
          "workout_evaluation_warm_stretch",
          "warm_stretch",
          { unique: false }
        );
        ...
        power_level.createIndex("powerlevel_bodyweight", "bodyweight", {
          unique: false,
        });
        power_level.createIndex("powerlevel_first_exercise", "first", {
          unique: false,
        });
        power_level.createIndex("powerlevel_second_exercise", "second", {
          unique: false,
        });
        power_level.createIndex("powerlevel_third_exercise", "third", {
          unique: false,
        });
