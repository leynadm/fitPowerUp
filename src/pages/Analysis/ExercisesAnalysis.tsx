...
function ExercisesGraph() {
  ...
  const statisticsOptions: { label: string }[] = getStatisticOptions() || [];

  const [selectedKPI, setSelectedKPI] = useState(statisticsOptions[0].label);
  ...
  useEffect(() => {
    fetchModeledData();
  }, [selectedKPI, selectedTimeframe, selectedDataGroup]);
