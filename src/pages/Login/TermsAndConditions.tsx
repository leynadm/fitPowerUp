...
function TermsAndConditions() {
  return (
    <Box sx={{ display: "flex", padding: "1rem", flexDirection: "column" }}>
      ...
      changes to the online component that may affect their usage experience.
      However, it is the user's responsibility to review and stay updated with
      the app's announcements, notifications, and terms of use to understand any
      limitations or changes that may apply.
      <br></br>d. The free use of the app's core features, as described in these
      Terms and Conditions, will not be adversely affected by any limitations
      placed on the online component, unless explicitly stated.
      <br></br>
      <br></br>
      <strong>User Content</strong> a. By using the App, you may have the
      opportunity to upload, submit, or post content, including but not limited
      to text and photos ("User Content"). <br></br>b. You retain ownership of
      your User Content, but by submitting it to the App, you grant me a
      non-exclusive, royalty-free, worldwide, sublicensable, and transferable
      license to use, reproduce, modify, adapt, publish, translate, distribute,
      publicly display and perform your User Content in connection with the
      operation and promotion of the App. <br></br>c. You are solely responsible
      for your User Content and any consequences resulting from its submission,
      including any reliance by others on its accuracy or legality. <br></br>d.
      You must not upload, submit, or post User Content that is unlawful,
      harmful, defamatory, infringing, abusive, obscene, or otherwise
      objectionable.
      <br></br>
      <br></br>
      ...
      Privacy Policy. Please read this Privacy Policy carefully and periodically
      ...
      believe that fitPowerUp or its users have infringed upon your intellectual
      property rights, please contact me immediately.
      <br></br>
